...
public class EnemySpawner : MonoBehaviour
{
    ...
    private int currentNrOfEnemies = 0;
    private const int nrOfStandardGroupsToSpawn = 75; //Define more of these variables to define how many of other kinds of units to spawn
    private const int nrOfPartitions =5;
    private const int chanceToSpawnInPercent = 30;
    private void Start()
    {
    ...
    public int SpawnGroup(int cellIndex)
    {
        ...
        currentNrOfEnemies += nrOfCreatedEnemies;
